...
def menu_screen():
    ...
    while not menu_done:  
        screen.fill(white)
        blit_text(screen, 'Tours de Hanoi', (323,122), font_name='sans serif', size=90, color=grey)
        blit_text(screen, 'Tours de Hanoi', (320,120), font_name='sans serif', size=90, color=gold)
        blit_text(screen, 'Selectionner la difficulté :', (320, 220), font_name='sans serif', size=30, color=black)
        blit_text(screen, str(n_disks), (320, 260), font_name='sans serif', size=40, color=blue)
        blit_text(screen, 'Appuyer sur entrer pour lancer le jeu', (320, 320), font_name='sans_serif', size=30, color=black)
...
def game_over():
    ...
    blit_text(screen, 'Fin', (320, 200), font_name='sans serif', size=72, color=gold)
    blit_text(screen, 'Fin', (322, 202), font_name='sans serif', size=72, color=gold)
    blit_text(screen, 'Nombre de mouvements : '+str(steps), (320, 360), font_name='mono', size=30, color=black)
    blit_text(screen, 'Mouvements minimum : '+str(min_steps), (320, 390), font_name='mono', size=30, color=red)
    if min_steps==steps:
        blit_text(screen, 'Solution parfaite', (320, 300), font_name='mono', size=26, color=green)
    pygame.display.flip()
...
def draw_towers():
    ...
    blit_text(screen, 'Tour A', (towers_midx[0], 403), font_name='mono', size=14, color=black)
    blit_text(screen, 'Tour B', (towers_midx[1], 403), font_name='mono', size=14, color=black)
    blit_text(screen, 'Tour C', (towers_midx[2], 403), font_name='mono', size=14, color=black)
...
while not game_done:
    ...
    draw_disks()
    draw_ptr()
    blit_text(screen, 'Nombre de mouvements: '+str(steps), (320, 20), font_name='mono', size=30, color=black)
    pygame.display.flip()
